  ...
  <div class="container mx-auto p-2 text-center" style="max-width: 500px;">
    <div class="d-flex">
      <div class="input-group mb-3">
        ...
        <input type="text" id="formGroupExampleInput2" class="form-control" placeholder="Nom , spécialité"  aria-describedby="basic-addon1" name="specialiste" value="<?php echo $_POST['nom'] ?>">
      </div>
      <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">🏥</span>
        <input type="text" id="formGroupExampleInput2" class="form-control" placeholder="Lieu"  aria-describedby="basic-addon1" name="lieu" value="<?php echo $_POST['lieu'] ?>">
      </div>
